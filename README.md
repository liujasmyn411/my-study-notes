...
二进制：7是1在4位，1在2位，1在个位 1* 4+1* 2+1* 1=7 7在二进制中表示为110，65535表达为2进制是16个1，bit是二进制中最小的位，八个比特为一个字节。ASCII是计算机的摩斯密码，共计128个，在ASCII中大写A的编码为65，所以当我们在键盘上输入A时，在计算机二进制的存储中A被表示为1000001。GB2312收录了6763个常用汉字，682个字符。GBK收录的汉字和符号达到了20000+，并且支持繁体中文。UTF-8为万国码，包含世界上所有语言的文字和符号 
